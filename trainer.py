...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default ="/Users/aidanamassalimova/Documents/PointNet_data", type=str,  help="dataset path")
    parser.add_argument('--class_choice', type=str, default='spine'
                                                            '', help="class_choice")
