...
class SpineDepthDataset(data.Dataset):
    def __init__(self,
                 root,
                 npoints=100000,
                 num_channels=3,
    ...
    def __getitem__(self, index):
        ...
        if self.classification:
            ...
            return point_set, seg, fn[1], dist, trans
...
if __name__ == '__main__':
    ...
    if dataset == 'spinedepth':
        d = SpineDepthDataset(root=datapath, class_choice=['Chair'])
        ps, seg = d[0]

        d = SpineDepthDataset(root=datapath, classification=True)
        ps, cls = d[0]
